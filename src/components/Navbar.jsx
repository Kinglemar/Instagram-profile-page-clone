...
const Navbar = () => {
  let [flip, trigger] = useState(false)
  ...
  return (
    <nav className='navbar mx-auto'>
      ...
      <div className="third _acur h-[60px]">
        ...
        <div className="link">
          <span className="border border-slate-600 rounded-full" role="link" tabIndex="0"><img width="24px" height="24px" alt="truk_de_world's profile picture" crossOrigin="anonymous" draggable="false" />
          </span>
        </div>
      </div>
    </nav>
