...
const Navbar = ({ uploadPicture}) => {
  ...
  return (
    <nav className='navbar mx-auto'>
      ...
      <div className="_aawf _aawg _aexm input-field">
        <input onFocus={() => {
          trigger(true)
        ...
        {/* <div className="_aaw8" role="button" tabIndex="0">
          <div className="_aaw9">
            ...
            <span className="_aawc _aawd">Search</span>
          </div>
        </div> */}
      ...
      <div className="_acuq _acur h-[60px]">
        <div className="link">
        ...
        <div onClick={uploadPicture} className="link">
